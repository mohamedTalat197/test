                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email">اسم المتجر  </label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email">لوجو المتجر</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email">اسم الكوبون</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email">اللينك</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email">الكود</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email">كود مميز</label>
                                <select  id="isSpecial" name="isSpecial"  class="form-control"   >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email">البلد</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select  id="country_id" name="cat_id"  class="form-control"   >
                                    @foreach($cats as $row)
                                        <option value="{{$row->id}}">{{$row->name_ar}}</option>
                                    @endforeach
                                </select>
